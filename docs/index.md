...
- **Agent framework support**: Pre-built [`Agent`][group_genie.agent.base.Agent] implementations for Pydantic AI and the OpenAI Agents SDK, allowing you to use existing agents from these frameworks in group chats without modification.
